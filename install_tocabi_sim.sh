...
# TOCABI Simulation Installation Script for Ubuntu 24.04
# This script installs Distrobox, creates an Ubuntu 20.04 container, and sets up ROS Noetic & TOCABI Simulation.
...
# Step 2: Create Ubuntu 20.04 Container
echo "[Step 2] Creating Ubuntu 20.04 container using Distrobox..."
mkdir -p ~/ubuntu-20-04  # Create a directory for the container home
...
echo "[Step 3] Entering Ubuntu 20.04 container and installing ROS Noetic..."
distrobox enter ubuntu-20-04 -- sh -c "
    set -e
    sudo apt update -y
...
echo "[Step 4] Installing TOCABI Simulation in the container..."
distrobox enter ubuntu-20-04 -- sh -c "
    set -e
    sudo apt update -y
...
echo "[Installation Complete!] You can now enter the container using: distrobox enter ubuntu-20-04"
